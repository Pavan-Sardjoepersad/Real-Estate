...
<html lang="en">
    ...
    <body>
        <div>
            ...
            <section class="p-12 text-center bg-gradient-to-r from-blue-200 to-blue-500 lg:p-40">
                <h1 class="mb-2 text-2xl font-bold text-gray-700 lg:text-5xl">
                    Find Your Dream House</h1>

                <p class="mb-8 mt-4 text-lg text-center text-white">Your journey to the perfect <span class="text-blue-700">house</span> starts here</p>
                ...
                <div class="flex items-center justify-center space-x-2">
                    ...
                    <a href="#"
                        class="px-4 py-2 text-black transition duration-200 bg-white rounded-lg lg:px-8 lg:py-3 hover:bg-blue-300 hover:text-white hover:shadow-xl">Buy
                        Now</a>
                </div>
            </section>
