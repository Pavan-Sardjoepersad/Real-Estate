        ...
        <div class="mt-2 space-y-2 lg:gap-4 flex  flex-column justify-center items-center flex-wrap ">
            ...
            <div class="p-4 bg-gray-200 rounded-lg sm:flex sm:flex-column w-full sm:w-auto">
                ...
                <div class=" mt-4 sm:mt-auto sm:px-6 sm:py-1">
                    <h3 class="text-blue-700 text-lg font-semibold cursor-pointer">Oranjestraat 6</h3>
                    <h3 class="text-lg font-medium cursor-pointer">7443 CC Nijverdal</h3>

                    <div class="mt-2">
                        <span class="text-lg font-semibold ">€ 574.500 k.k.</span>
                    </div>
                    ...
                    <div class="flex justify-start gap-8 mt-3 pl-1 text-gray-700 ">
                        ...
                        <div class="flex items-center">
                            ...
                            <p><span class=" text-gray-900">3</span> </p>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <p><span class=" text-gray-900">2</span></p>
                        </div>
                    </div>
                    <h3 class="text-blue-700 text-md mt-3 font-medium cursor-pointer">PS Makelaars</h3>
                </div>
